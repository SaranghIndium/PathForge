...
namespace SerapKeremGameKit._Managers
{
    ...
    public class LevelManager : MonoSingleton<LevelManager>
    {
        ...
        [Tooltip("Total number of designed progression levels before wrapping.")]
        [SerializeField, Min(1)] private int _designedLevelCount = 40;
        ...
        public int CurrentDesignedLevelNumber => NormalizeDesignedLevel(ActiveLevelNumber);
        ...
        {
            int currentProgress = CurrentDesignedLevelNumber;
        ...
        private int NormalizeDesignedLevel(int rawLevel)
        {
            int designedCount = Mathf.Max(1, _designedLevelCount);
            if (rawLevel <= designedCount)
            {
                return Mathf.Max(1, rawLevel);
            }

            return WrapIndex(rawLevel, designedCount);
        }
