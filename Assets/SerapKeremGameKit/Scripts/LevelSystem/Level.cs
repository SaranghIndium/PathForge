...
namespace SerapKeremGameKit._LevelSystem
{
    public class Level : MonoBehaviour
    {
        ...
        [Tooltip("Optional background sprite displayed behind the level. Drag any sprite asset here.")]
        [SerializeField] private Sprite _backgroundSprite;
        [Tooltip("Color tint for the background sprite.")]
        [SerializeField] private Color _backgroundColor = Color.white;
        [Tooltip("Sorting order for the background (lower = further back).")]
        [SerializeField] private int _backgroundSortingOrder = -10;
        ...
        private void InitializeBackground()
        {
            ...
            Transform existing = transform.Find("LevelBackground");
            ...
            sr.sortingOrder = _backgroundSortingOrder;
        }
