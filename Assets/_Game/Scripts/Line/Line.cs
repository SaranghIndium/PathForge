...
namespace _Game.Line
{
    ...
    public class Line : MonoBehaviour
    {
        ...
        [Header("Line Reskin")]
        [SerializeField] private bool _applyDefaultReskin = true;
        [SerializeField] private float _lineWidth = 0.18f;
        [SerializeField] private Color _lineStartColor = new Color(0.12f, 0.84f, 1f, 1f);
        [SerializeField] private Color _lineEndColor = new Color(0.12f, 1f, 0.75f, 1f);
        [SerializeField] private Color _lineHeadColor = new Color(0.98f, 0.98f, 1f, 1f);
        ...
        private void ApplyLineReskin()
        {
            ...
            gradient.SetKeys(
                new[]
                {
                    new GradientColorKey(_lineStartColor, 0f),
                    new GradientColorKey(_lineEndColor, 1f)
                },
                new[]
                {
            ...
            if (_lineRenderer.sharedMaterial == null)
            {
                ...
                {
                    Material runtimeMaterial = new Material(defaultShader);
                    runtimeMaterial.color = _lineStartColor;
                    _lineRenderer.material = runtimeMaterial;
                }
            }

            if (_lineHeadSpriteRenderer != null)
            {
                _lineHeadSpriteRenderer.color = _lineHeadColor;
            }
        }
